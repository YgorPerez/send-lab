	...
	dayTypes: [
		{
			...
			headline: 'Recruitment pulls → Boulder no limite',
			subhead: 'Força de contato e RFD, depois os boulders mais duros',
			load: 'ALTO',
			color: 'var(--flag)',
		...
		},
		{
			id: 'pinch-wrist',
			type: 'Pinça / Punho',
			headline: 'Pinch block + Punho / Sloper',
			subhead: 'Abrahangs de manhã · antagonistas',
			load: 'MOD',
			color: 'var(--gold)',
		...
		},
		{
			id: 'endurance',
			type: 'Resistência',
			headline: 'Repeaters 7/3 → Escalada esportiva',
			subhead: 'Resistência de força, força crítica, pump',
			load: 'ALTO',
			color: 'var(--flag)',
			ex: ['repeaters', 'sport'],
		},
		{
			id: 'pull',
			type: 'Puxada',
			headline: 'Dia de puxada pesada + Densidade em sloper',
			subhead: 'Barras com peso, OAP · Abrahangs de manhã',
			load: 'MOD',
			color: 'var(--violet)',
		...
		},
		{
			id: 'max-tissue',
			type: 'Máx / Tecido',
			headline: 'Max hangs (manutenção) + Densidade',
			subhead: 'Investir no tecido, densidade da JMT',
			load: 'MOD',
			color: 'var(--teal)',
			ex: ['maxhang', 'density'],
		},
		{
			id: 'performance',
			type: 'Performance',
			headline: 'Rocha / Performance',
			subhead: 'Hangboard = só aquecimento',
			load: 'ALTO',
			color: 'var(--flag)',
			ex: ['perform'],
		},
		{
			id: 'rest',
			type: 'Descanso',
			headline: 'Descanso total',
			subhead: 'Sem carga nos dedos · caminhada / mobilidade',
			load: 'FOLGA',
			color: 'var(--ink-faint)',
			ex: ['rest'],
		},
