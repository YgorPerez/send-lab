	...
	dayTypes: [
		{
			id: 'limit-power',
			type: 'Limit / Power',
			headline: 'Recruitment pulls → Limit bouldering',
			subhead: 'Contact strength / RFD, then hardest problems',
			load: 'HIGH',
			color: 'var(--flag)',
		...
		},
		{
			id: 'pinch-wrist',
			type: 'Pinch / Wrist',
			headline: 'Pinch block + Wrist / Sloper',
			subhead: 'Abrahangs AM · antagonists',
			load: 'MOD',
			color: 'var(--gold)',
		...
		},
		{
			id: 'endurance',
			type: 'Endurance',
			headline: '7/3 Repeaters → Sport climbing',
			subhead: 'Strength-endurance, critical force, pump',
			load: 'HIGH',
			color: 'var(--flag)',
			ex: ['repeaters', 'sport'],
		},
		{
			id: 'pull',
			type: 'Pull',
			headline: 'Heavy pull day + Sloper density',
			subhead: 'Weighted pull-ups, OAP · Abrahangs AM',
			load: 'MOD',
			color: 'var(--violet)',
		...
		},
		{
			id: 'max-tissue',
			type: 'Max / Tissue',
			headline: 'Max hangs (maintenance) + Density',
			subhead: 'Tissue investment, MTJ density',
			load: 'MOD',
			color: 'var(--teal)',
			ex: ['maxhang', 'density'],
		},
		{
			id: 'performance',
			type: 'Performance',
			headline: 'Outdoor / Performance',
			subhead: 'Hangboard = warm-up only',
			load: 'HIGH',
			color: 'var(--flag)',
			ex: ['perform'],
		},
		{
			...
			type: 'Rest',
			headline: 'Full rest',
			subhead: 'No finger loading · walk / mobility',
			load: 'OFF',
			color: 'var(--ink-faint)',
			ex: ['rest'],
		},
